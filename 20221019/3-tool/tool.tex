...
\begin{frame}
  ...
  \framesubtitle{}
  \begin{itemize}
    \item connect to the instance provided by ILR;
    \item training instances are : \url{https://serima.lu/cases_telco/} and \url{https://serima.lu/cases_telco/}
    \item MONARC login and password: provided by ILR.
  \end{itemize}
