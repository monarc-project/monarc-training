...
\begin{frame}
    ...
    \begin{center}
        \begin{itemize}
            ...
            \item \textbf{software}:
                MONARC\footnote{\url{https://github.com/monarc-project}}, Fit4Cybersecurity, Fit4Contract, Fit4Gdpr (coming soon) MOSP, TACOS, etc.\footnote{\url{https://github.com/CASES-LU}}
            \item \textbf{cooperation}:
                ANSSI LU (National Information Systems Security Agency), CCB (Centre for cybersecurity Belgium) and others
        \end{itemize}
    \end{center}
\end{frame}
