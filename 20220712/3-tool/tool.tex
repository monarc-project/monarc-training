...
\begin{frame}
  ...
  \framesubtitle{}
  \begin{itemize}
    \item connect to the VPN as explained in the document from IBPT;
    \item training instances are : \url{https://serima.be/training-telco/} and \url{https://serima.be/training-tld/}
    \item MONARC login and password: provided by IBPT.
  \end{itemize}
